...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      spend: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`spend: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const result_0 = this._spend_0(context, partialProofData, amount_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = { spend: this.circuits.spend };
    this.provableCircuits = { spend: this.circuits.spend };
  }
  initialState(...args_0) {
    if (args_0.length !== 2) {
    ...
    if (!(typeof(limit_0) === 'bigint' && limit_0 >= 0n && limit_0 <= 4294967295n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'ghost.compact line 8 char 1',
                                 'Uint<0..4294967296>',
                                 limit_0)
    }
  ...
  _spend_0(context, partialProofData, amount_0) {
    let t_0;
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('ghost.compact line 15 char 17: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
